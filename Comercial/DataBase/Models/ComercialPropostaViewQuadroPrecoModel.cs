...
namespace Comercial.DataBase.Models
{
    [Keyless]
    [Table("proposta_view_quadropreco", Schema = "comercial")]
    public class ComercialPropostaViewQuadroPrecoModel
    {
        ...
        public string?   obsintema   { get; set; }
