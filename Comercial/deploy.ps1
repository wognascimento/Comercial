...
$serverUploadPath = "root@192.168.0.49:/var/www/updates/downloads/comercial/"
...
$updateJson = @{
    ...
    updateUrl = "http://192.168.0.49/downloads/comercial/$zipFileName"
    changelog = @(
        "Ajustes",
        "Melhorias"
    )
...
scp "$projectPath\version.json" "root@192.168.0.49:/var/www/updates/downloads/comercial/version.json"
...
Copy-Item -Path "$projectPath\Output\Comercial.exe"  -Destination "RedeTemp:"
